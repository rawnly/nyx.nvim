...
---@type table<string, Palette|fun(opts:nyx.Config):Palette>
M.styles = setmetatable({}, {
  __index = function(_, style)
    return vim.deepcopy(Util.mod("nyx.colors." .. style))
  end,
})
...
function M.setup(opts)
  ...
  colors.bg_statusline = Util.blend_bg(colors.bg_dark, 0.2, colors.bg)
