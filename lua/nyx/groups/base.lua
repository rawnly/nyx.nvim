...
function M.get(c, opts)
  ...
  return {
    ...
    FloatBorder                 = { fg = c.orange, bg = c.bg_float },
    ...
    LspReferenceText            = { bg = Util.blend_bg(c.fg_gutter, 0.5), underline = true }, -- used for highlighting "text" references
    LspReferenceRead            = { bg = Util.blend_bg(c.fg_gutter, 0.5), underline = true }, -- used for highlighting "read" references
    LspReferenceWrite           = { bg = Util.blend_bg(c.fg_gutter, 0.5), underline = true }, -- used for highlighting "write" references
