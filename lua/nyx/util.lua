...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/nyx-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, nyx.Cache
